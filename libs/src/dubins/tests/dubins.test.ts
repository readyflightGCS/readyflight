...
test('find dubins path straight up', () => {
  const path = DubinsBetweenDiffRad({ x: 0, y: 0 }, { x: 0, y: 10 }, 0, 0, 1, 1)
...
test('find dubins path straight east', () => {
  const path = DubinsBetweenDiffRad({ x: 0, y: 0 }, { x: 10, y: 0 }, Math.PI / 2, Math.PI / 2, 1, 1)
...
test('find dubins path east', () => {
  const path = DubinsBetweenDiffRad({ x: 0, y: 0 }, { x: 10, y: 0 }, 0, Math.PI, 1, 1)
