...
import { NamedValueString } from './messages/named-value-string'
...
import { CameraThermalRange } from './messages/camera-thermal-range'
...
import { Airspeed } from './messages/airspeed'
...
import { ParamError } from './messages/param-error'
...
import { FigureEightExecutionStatus } from './messages/figure-eight-execution-status'
import { FuelStatus } from './messages/fuel-status'
import { BatteryInfo } from './messages/battery-info'
...
import { ComponentInformationBasic } from './messages/component-information-basic'
import { ComponentMetadata } from './messages/component-metadata'
...
import { CurrentEventSequence } from './messages/current-event-sequence'
import { RequestEvent } from './messages/request-event'
import { ResponseEventError } from './messages/response-event-error'
import { AvailableModes } from './messages/available-modes'
import { CurrentMode } from './messages/current-mode'
import { AvailableModesMonitor } from './messages/available-modes-monitor'
import { IlluminatorStatus } from './messages/illuminator-status'
 ...
 */
export const messageRegistry: Array<
  [number, new (system_id: number, component_id: number) => MAVLinkMessage]
> = [
  [150, SensorOffsets],
  [151, SetMagOffsets],
  [152, Meminfo],
  ...
  [361, FigureEightExecutionStatus],
  [371, FuelStatus],
  [372, BatteryInfo],
  [373, GeneratorStatus],
