  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        label: 'Types',
        description:
          'Fence types to enable or disable as a bitmask. 0: all fences should be enabled or disabled (parameter is ignored, for compatibility reasons).Parameter is ignored if param1=2',
        units: '',
        minValue: null,
        maxValue: null,
        increment: null,
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        label: 'Axis',
        description:
          'Specify axes for which autotuning is enabled/disabled. 0 indicates the field is unused (for compatiblity reasons). If 0 the autopilot will follow its default behaviour, which is usually to tune all axes.',
        units: '',
        minValue: null,
        maxValue: null,
        increment: null,
