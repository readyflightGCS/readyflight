...
export function getCommandLabel(
  ...
  switch (cmd.type) {
    ...
    default:
      ...
      const exhaustiveCheck: `D.${string}` = cmd.type
 ...
 */
export function getCommandLocation(
  cmd: MissionCommand<DialectCommandDescription>,
  dialect: Dialect<DialectCommandDescription>
): LatLng | null {
  switch (cmd.type) {
 ...
 */
export function getCommandLocationAlt(
  cmd: MissionCommand<DialectCommandDescription>,
  dialect: Dialect<DialectCommandDescription>
): LatLngAlt | null {
  switch (cmd.type) {
...
export function getCommandDescription(
  cmdType: MissionCommand<DialectCommandDescription>['type'],
  dialect: Dialect<DialectCommandDescription>
) {
 ...
 */
export function coerceCommand<T extends DialectCommandDescription>(
  cmd: MissionCommand<T>,
 ...
 */
export function filterLatLngCmds(
 ...
 */
export function filterLatLngAltCmds(
  cmds: MissionCommand<DialectCommandDescription>[],
  dialect: Dialect<DialectCommandDescription>
) {
