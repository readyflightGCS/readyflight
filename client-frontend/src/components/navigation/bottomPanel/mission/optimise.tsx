...
export function Optimise() {
  ...
  function runOptimisation() {
    let res = bakeDubins(dialect, mission, selectedSubMission, algorithms[algorithm], setMission, metrics[metric], vehicle as Plane)
    setOptimiseRes(res)
  }

  let energy = staticEvaluate(dialect, mission, selectedSubMission, metrics["Energy"], vehicle as Plane)
  let length = staticEvaluate(dialect, mission, selectedSubMission, metrics["Length"], vehicle as Plane)

  let dubinSections = splitDubinsRuns(mission.mainLine(dialect, selectedSubMission))
