import { Airspeed, HeadingIndicator, AttitudeIndicator, Altimeter } from "react-typescript-flight-indicators";
      ...
      <div className=" row-span-2">
        <table className="table-fixed w-full">
            <tbody>
                ...
                <tr>
                    <td>Throttle: </td>
                    <td colSpan={3}><ThrottleIndicator/></td>
                </tr>
            </tbody>
        </table>
      </div>
